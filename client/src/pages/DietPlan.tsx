    ...
    <div className="max-w-4xl mx-auto">
      <Card>
        <CardHeader className="text-center">
          <CardTitle className="text-3xl font-bold">Personalized AI Diet Plan</CardTitle>
          <p className="text-gray-600">
            Based on your CKD risk assessment and AI analysis of your health parameters
          </p>
        </CardHeader>
        <CardContent>
          {/* Diet Type Toggle */}
